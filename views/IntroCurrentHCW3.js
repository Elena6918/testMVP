...
const IntroCurrentHCW3 = () =>{
  return(
    <SafeAreaView style={{ flex: 1, justifyContent: "center", alignContent: 'center', backgroundColor: '#1A056B',}}>
      <View style={styles.container}>
  
        <Text style={styles.header}> After matching with a peer supporter, you'll be able to start a conversation with them!  
</Text>
      <Image source={require('../assets/images/status.png')} style={styles.intro3}/> 
        ...
        {/* <Button 
                title = "Skip"
                buttonStyle={styles.button}
                onPress={() => navigate("UserHelpScreen")}
        />  */}
      </View>  
    </SafeAreaView>
 )
...
export default IntroCurrentHCW3