...
const IntroPeerSupporter1 = () =>{
  return(
    <SafeAreaView style={{ flex: 1, justifyContent: "center", alignContent: 'center', backgroundColor: '#1A056B',}}>
      <ScrollView style={styles.contentContainerStyle}>
      <View style={styles.container}>
  
        <Text style={styles.header}> Thank you for signing up!  First, you will use the modules to learn how to help a peer supporter. Each module has some videos and associated quizes that you must complete.  Click on a module to begin.  
</Text>
      <Image source={require('../assets/images/moduleworld.png')} style={styles.intro3}/> 
            <Button 
                title = "Next"
                buttonStyle={styles.button}
                onPress={() => navigate("PSIntro2")}
        /> 
        <Button 
                title = "Skip"
                buttonStyle={styles.button}
...
export default IntroPeerSupporter1