...
const IntroPeerSupporter3 = () =>{
  return(
    <SafeAreaView style={{ flex: 1, justifyContent: "center", alignContent: 'center', backgroundColor: '#1A056B',}}>
      <View style={styles.container}>
  
        <Text style={styles.header}> After you pass the certification, you now have access to the requests made by healthcare workers.  Select a query to begin! 
</Text>
      <Image source={require('../assets/images/query.png')} style={styles.intro3}/> 
            <Button 
                title = "Next"
                buttonStyle={styles.button}
                onPress={() => navigate("PSIntro4")}
        /> 
        <Button 
                title = "Skip"
                buttonStyle={styles.button}
...
export default IntroPeerSupporter3